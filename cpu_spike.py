...
def simulate_cpu_spike(duration=30, cpu_percent=30):
...
if __name__ == '__main__':
    # Simulate a CPU spike for 30 seconds with 30% CPU utilization
    simulate_cpu_spike(duration=30, cpu_percent=30)
